...
export const Main = () => {
    return (
        <>
            <div className="bg-bg-main bg-no-repeat bg-center bg-cover w-full h-[calc(100vh_-_4rem)] opacity-50 z-0 relative"></div>
            ...
            <main className="font-['Montserrat'] w-full h-[calc(100vh_-_4rem)] flex items-center justify-center flex-col z-1 absolute bottom-0">
                ...
                <div className="flex gap-4">
                    <Link to='/options'>
                        <button type="button" className="bg-orange-400 p-4 rounded-2xl text-lg w-40 hover:scale-110 duration-200 text-white mt-4">Escolha a sua
                        </button>
                    </Link>
